...
# ╔═╡ a8223693-3af8-443b-943c-f3fb8db1446a
md"""
# Example prediction
"""
...
begin
	f = initialize_network(nn_params; is_ensemble=true)
	data = get_dataset(τθ, target, initialstate; m=500) # trigger NN reinitialization
end

# ╔═╡ 81b331bf-b27a-4c91-83ad-a309b15d5033
md"""
> **Turn on training with this switch.**
"""
...
# ╔═╡ 46b8f3c9-6e8c-43cd-a623-654d72b720c5
md"""
# Visualizations
"""
...
# ╔═╡ 16c9a331-bab9-46d1-a4cb-74de5c978260
τ = violated_trajs[i];

# ╔═╡ c2bfdf61-c304-4017-b3df-23b2f063cd6c
@bind τᵢ Slider(eachindex(τ))
...
# ╔═╡ 4808abfc-b861-4203-8741-55831c429879
begin
	create_gif([τ], target, initialstate; callback=(trajs, target, initialstate; kwargs...)->plot_traj_and_prediction(trajs[1], target, initialstate; f=f′, cmap, kwargs...), filename="traj_and_pred.gif")
	LocalResource("./traj_and_pred.gif")
end
